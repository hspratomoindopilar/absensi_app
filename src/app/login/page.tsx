  ...
  return (
    ...
    >
      <div className="w-full max-w-md bg-white/85 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-100 p-8 space-y-6 relative overflow-hidden">
        ...
        {/* WATERLOGO DIPERKECIL DI TENGAH */}
        ...
        {/* Konten form di dalam card dibungkus relative agar berada di atas watermark */}
        <div className="relative z-10 space-y-6">
          ...
          <div className="text-center space-y-1.5">
            ...
            <div className="space-y-0.5">
              <h1 className="text-xl font-bold tracking-tight text-slate-900">Aplikasi Absensi Kelas </h1>
              <p className="text-xs text-slate-500 font-medium">Masuk untuk mengelola kelas anda</p>
            </div>
          </div>
